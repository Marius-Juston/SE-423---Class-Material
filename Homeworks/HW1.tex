...
\begin{tabular}{|p{0.13\columnwidth}|p{0.39\columnwidth}|p{0.42\columnwidth}|}
\hline
...
if (GpioDataRegs.GPADAT.bit.GPIO19 == 1) {
    // Code executed when input pin GPIO19 is High (3.3V)
} else {
    // Code executed when input pin GPIO19 is Low (0V/GND)
}
\end{minted}
\end{minipage}
\\ \hline
