...
SpibRegs.SPIFFTX.bit.SPIRST = ???;// Pull SPI FIFO out of reset, SPI FIFO can resume transmitting or receiving.
...
SpibRegs.SPIFFRX.bit.RXFFIL =???; //Interrupt Level to 16 words or more received into FIFO causes an interrupt. This is just the initial setting for the register. Will be changed below
\end{minted}
...
__interrupt void SPIB_isr(void){
    ...
    GpioDataRegs.???? = ???; // Set GPIO 66 high to end Slave Select. Now to Scope. Later, deselect the MPU9250.
...
void setupSpib(void) //Call this function in main() somewhere after the DINT; line of code.
{
    int16_t temp = 0;
Step 1.
    // cut and paste all the SpibRegs initializations you found for part 3 here. Also, do not forget to cut and paste the GPIO settings for GPIO63, 64, 65, and 66, which are part of the SPIB setup. 
    //-----------------------------------------------------------------------------------------------------------------
