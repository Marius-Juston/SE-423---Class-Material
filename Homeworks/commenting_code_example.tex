...
void main(void)
{
    ...
    ConfigCpuTimer(&CpuTimer0, 200, 5000); //|\textcolor{red}{\textbf{AAJ}}| Set CPU Timer 0 to call its interrupt function every 5ms. 
    ...
    {
        if (UARTPrint == 1 ) {
            // |\textcolor{red}{\textbf{AAJ}}| Here I am using GPIO67 to see how much time the serial_printf function takes to run. 
            // In lab I will connect the Oscilloscope to GPIO67's pin and measure the width of the pulse created by setting GPIO67
            // high (3.3Volts) before the function is called and then setting GPIO67 low (0Volts) after the function is completed. 
            // GPIO67 is controlled by the GPC registers. GPIO67 is the 4th bit in the GPC registers. Bit 0 is for GPIO64 Bit 1 
            // is for GPIO65, Bit 2 is for GPIO66, Bit 3 is for GPIO67, Bit 4 is for GPIO68 and so on. The below bitfield C 
