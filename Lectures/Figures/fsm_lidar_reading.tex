...
% STATES
% -------------------------
\node[state, initial, initial text={\textbf{RXC Interrupt}}, initial where=above] (WaitG) {
...
(DataLo) edge [loop above, looseness=5] node [transition, above]  {\texttt{RXC == 0x0a}\\ \texttt{LF\_count += 1}} (DataLo);
