...
\node[process, fill=orange!20, draw=orange!80!black] (lidar) at (12, -3) {LiDAR};

\draw[<-, thick, draw=black] (lidar.north west) -- (RedBoard.south east) node[midway, above, font=\sffamily\scriptsize, align=center] {Transmit 'G' command};


\draw[->, thick, draw=black] (lidar.north east) -- (RedBoard.north east) node[midway, above, font=\sffamily\scriptsize, align=center] {Send LiDAR point};

\draw[->, thick, draw=black] (lidar.south west) -- (Ladar.north east) node[midway, above, font=\sffamily\scriptsize, align=center] {Send LiDAR point through UART3};
