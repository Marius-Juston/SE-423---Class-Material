...
% lost in HTML — describe them in alt text or surrounding prose if
% they carry meaning, since this fallback exists purely so the photo
% is visible at all in the accessible HTML build.
% Usage:
%   \Annotated[width=\linewidth]{path/to/photo.jpg}{%
%       \draw[red, thick] (0.225,0.825) ellipse (0.15 and 0.15);
%   }
\NewDocumentCommand{\Annotated}{O{} m +m}{%
  \ifSEhtml
    \includegraphics[#1]{#2}%
  \else
    \begin{tikzpicture}
