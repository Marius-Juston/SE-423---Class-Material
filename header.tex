...
\ifSEhtml
  ...
  % --- FIX FOR LISTINGS (lstinline and lstlisting) IN DARK MODE ---
  % \Css{code.lstinline { color: inherit !important; background: transparent !important; }}
  % \Css{pre.lstlisting { color: inherit !important; background: transparent !important; }}
  % \Css{pre.lstinputlisting { color: inherit !important; background: transparent !important; }}
