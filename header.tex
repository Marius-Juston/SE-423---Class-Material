...
\textbf{Make sure that you \textcolor{red}{comment} you code and put your \textcolor{red}{initials} in your Gradescope submission! See \url{https://marius-juston.github.io/SE-423---Class-Material/Homeworks/commenting_code_example.pdf} for how we expect the code to be commented like!}
\end{tcolorbox}
}